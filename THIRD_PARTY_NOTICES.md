...
- Unitree G1 description and meshes: `unitreerobotics/unitree_ros`, commit
  ...
  retained at `assets/common/g1_5010_support/unitree_ros/LICENSE`.
- InstinctLab torso-rooted training collision model: `project-instinct/InstinctLab`,
  ...
  is retained at `assets/common/g1_5010_support/instinctlab/LICENSE`.
...
recorded in the Petal/Rotary 5010 manifests. The 4010 origins and capture
status are recorded in their corresponding manifests.
