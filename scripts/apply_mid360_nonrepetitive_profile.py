...
TRAJECTORY = ROOT / "assets/mid360_pattern/mid360.csv"
ASSETS = (
    ROOT / "assets/g1_29dof_rev_1_0/G1_29dof_mid360.usd",
    ROOT / "assets/g1_29dof_mode_13_5010/G1_29dof_mode_13_5010_mid360.usd",
)
...
def update_repository_hashes() -> None:
    """Synchronize published file hashes after rewriting the binary USDs."""
    ...
    for entry in catalog["assets"].values():
        ...
        manifest["files"][asset_path.name] = {
            "bytes": asset_path.stat().st_size,
            "sha256": entry["sha256"],
        }
        if "source" in manifest and "mid360_source_sha256" in manifest["source"]:
            manifest["source"]["mid360_source_sha256"] = sha256(ASSETS[0])
